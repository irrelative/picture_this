...
func PlayerView(gameID string, playerID int, playerName string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</strong>.</p></div><ul id=\"playerList\" class=\"player-list\"></ul></section><section id=\"drawSection\" class=\"panel draw-panel\"><div><h2>Draw your prompt</h2><p>Use your finger or mouse to sketch. Resolution is fixed for fair play.</p></div><div class=\"canvas-wrap\"><canvas id=\"drawCanvas\" width=\"800\" height=\"600\"></canvas><div class=\"canvas-actions\"><button type=\"button\" id=\"clearCanvas\" class=\"secondary\">Clear</button> <button type=\"button\" id=\"saveCanvas\" class=\"primary\">Save drawing</button></div></div></section><p id=\"playerError\" class=\"result error\"></p><div id=\"playerMeta\" data-game-id=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/player.templ`, Line: 45, Col: 44}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/player.templ`, Line: 45, Col: 72}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/player.templ`, Line: 45, Col: 104}
			}
